...
public class Tile {
	...
	public static Tile levelComplete=new AirTile(30,null);
	...
	public static Tile spikeTile5=new SpikeTile(29,true,new Polygon(new int[] {8,TILEWIDTH/2,TILEWIDTH-8},new int[] {0,(TILEHEIGHT/4)*3-8,0},3),Assets.spike5);
